/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a3ccc9ba0bd65bc0503e5ec128cb0133)
// Runtime types generated with workerd@1.20260815.1 2026-08-20 nodejs_compat
interface __BaseEnv_Env {
	RECEIPTS: R2Bucket;
	DB: D1Database;
	ASSETS: Fetcher;
	APP_ENV: "test" | "production" | "local";
	APP_BASE_URL: "https://webblyftet-finance-test.webblyftet-finance-test.workers.dev" | "https://DIN-PRODUKTIONSDOMAN" | "http://localhost:8787";
	STRIPE_PUBLISHABLE_KEY: "pk_test_51U6ZmLL9e4dgLD86WH5KUyN7HFU9M5TaCrSTI8yptqPMr7HRNTO3zqStWovaoBcqzSzB6TaRGqpRWLMzcTPcHv8V00tQMP6XKm" | "pk_live_REPLACE_WITH_STRIPE_PUBLISHABLE_KEY" | "pk_test_REPLACE_WITH_STRIPE_PUBLISHABLE_KEY";
	REQUIRE_CLOUDFLARE_ACCESS: "true" | "false";
	CF_ACCESS_TEAM_DOMAIN: "gentle-snowflake-b0da.cloudflareaccess.com" | "REPLACE_WITH_ZERO_TRUST_TEAM.cloudflareaccess.com";
	CF_ACCESS_AUD: "645cd3856053b06108fe4a47d3e9bf5e0b2235258836b97ec061ba1fec657aca" | "REPLACE_WITH_ACCESS_APPLICATION_AUD";
	MAX_RECEIPT_UPLOAD_BYTES: "10485760";
	EMAIL_FROM: "onboarding@resend.dev" | "offers@REPLACE_WITH_VERIFIED_DOMAIN";
	EMAIL_FROM_NAME: "Webblyftet";
	EMAIL_REPLY_TO: "ekonomi@REPLACE_WITH_VERIFIED_DOMAIN";
	ADMIN_ALERT_EMAIL: "wisen@creziainvest.se" | "REPLACE_WITH_ADMIN_ALERT_EMAIL" | "";
	ENABLE_EMAIL_AUTOSEND: "true" | "false";
	...
	LOCAL_DEV_EMAIL: "" | "local-admin@webblyftet.test";
	ADMIN_EMAILS: "sandberg@creziainvest.se,wisen@creziainvest.se" | "REPLACE_WITH_ADMIN_EMAILS" | "local-admin@webblyftet.test";
	FINANCE_EMAILS: "" | "REPLACE_WITH_FINANCE_EMAILS";
	SELLER_EMAILS: "" | "REPLACE_WITH_SELLER_EMAILS";
	READ_ONLY_EMAILS: "" | "REPLACE_WITH_READ_ONLY_EMAILS";
...
declare namespace Cloudflare {
	...
	interface TestEnv {
		...
		ASSETS: Fetcher;
		APP_ENV: "test";
		APP_BASE_URL: "https://webblyftet-finance-test.webblyftet-finance-test.workers.dev";
		STRIPE_PUBLISHABLE_KEY: "pk_test_51U6ZmLL9e4dgLD86WH5KUyN7HFU9M5TaCrSTI8yptqPMr7HRNTO3zqStWovaoBcqzSzB6TaRGqpRWLMzcTPcHv8V00tQMP6XKm";
		REQUIRE_CLOUDFLARE_ACCESS: "true";
		CF_ACCESS_TEAM_DOMAIN: "gentle-snowflake-b0da.cloudflareaccess.com";
		CF_ACCESS_AUD: "645cd3856053b06108fe4a47d3e9bf5e0b2235258836b97ec061ba1fec657aca";
		MAX_RECEIPT_UPLOAD_BYTES: "10485760";
		EMAIL_FROM: "onboarding@resend.dev";
		EMAIL_FROM_NAME: "Webblyftet";
		EMAIL_REPLY_TO: "ekonomi@REPLACE_WITH_VERIFIED_DOMAIN";
		ADMIN_ALERT_EMAIL: "wisen@creziainvest.se";
		ENABLE_EMAIL_AUTOSEND: "true";
		FORTNOX_SCOPES: "companyinformation customer invoice offer order payment supplier supplierinvoice bookkeeping inbox connectfile settings print";
		LOCAL_DEV_EMAIL: "";
		ADMIN_EMAILS: "sandberg@creziainvest.se,wisen@creziainvest.se";
		FINANCE_EMAILS: "";
		SELLER_EMAILS: "";
		READ_ONLY_EMAILS: "";
		TOKEN_ENCRYPTION_KEY_BASE64: string;
	...
	interface ProductionEnv {
		...
		ASSETS: Fetcher;
		APP_ENV: "production";
		APP_BASE_URL: "https://DIN-PRODUKTIONSDOMAN";
		STRIPE_PUBLISHABLE_KEY: "pk_live_REPLACE_WITH_STRIPE_PUBLISHABLE_KEY";
		REQUIRE_CLOUDFLARE_ACCESS: "true";
		CF_ACCESS_TEAM_DOMAIN: "REPLACE_WITH_ZERO_TRUST_TEAM.cloudflareaccess.com";
		CF_ACCESS_AUD: "REPLACE_WITH_ACCESS_APPLICATION_AUD";
		MAX_RECEIPT_UPLOAD_BYTES: "10485760";
		EMAIL_FROM: "offers@REPLACE_WITH_VERIFIED_DOMAIN";
		EMAIL_FROM_NAME: "Webblyftet";
		EMAIL_REPLY_TO: "ekonomi@REPLACE_WITH_VERIFIED_DOMAIN";
		ADMIN_ALERT_EMAIL: "REPLACE_WITH_ADMIN_ALERT_EMAIL";
		ENABLE_EMAIL_AUTOSEND: "true";
		FORTNOX_SCOPES: "companyinformation customer invoice offer order payment supplier supplierinvoice bookkeeping inbox connectfile settings print";
		LOCAL_DEV_EMAIL: "";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "APP_BASE_URL" | "STRIPE_PUBLISHABLE_KEY" | "REQUIRE_CLOUDFLARE_ACCESS" | "CF_ACCESS_TEAM_DOMAIN" | "CF_ACCESS_AUD" | "MAX_RECEIPT_UPLOAD_BYTES" | "EMAIL_FROM" | "EMAIL_FROM_NAME" | "EMAIL_REPLY_TO" | "ADMIN_ALERT_EMAIL" | "ENABLE_EMAIL_AUTOSEND" | "FORTNOX_SCOPES" | "LOCAL_DEV_EMAIL" | "ADMIN_EMAILS" | "FINANCE_EMAILS" | "SELLER_EMAILS" | "READ_ONLY_EMAILS" | "TOKEN_ENCRYPTION_KEY_BASE64" | "RESEND_API_KEY" | "RESEND_WEBHOOK_SECRET">> {}
}
